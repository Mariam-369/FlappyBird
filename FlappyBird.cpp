...
int score = 0;
int finishLine = (barrierX3 + (2 * barrierGap) + 100);
bool won = false;
...
void drawFinishLine() {
    ...
    glVertex3f(finishLine, 0, 0.0f);
    glVertex3f(finishLine, screenHeight, 0.0f);
    glEnd();
}
...
void drawBarrier(float x, float y, float w, float h, std::string type) {
    ...
    //else if (powerupFlag && (type == "powerup")) {
...
void printLives() {
    ...
    if (lives == 3) {
        ...
        roofX2 = -1000000;
        roofX3 = -1000000;
        powerupBottom = -100000000;
        powerupTop = -100000000;
        bird = -100000000;
        birdY = -1000000000;
        ...
        print((screenWidth / 2) - 95, (screenHeight / 2), (char*)p0s);
        sprintf((char*)p0s, "Total score: %d", score);
        print((screenWidth / 2) - 93, (screenHeight / 2) - 50, (char*)p0s);

        glFlush();
    }
    if (bird >= finishLine) {
        cout << "finishLine" << finishLine << endl;
        won = true;
        glColor3f(0, 0, 0);
        char* p0s[20];
...
void powerUpCollision(int setNumCol, string type) {
    if ((bird >= ((barrierX2 + powerupBottom) - 27)) && (bird <= ((barrierX2 + powerupBottom) + 27))) {
        cout << birdY << endl;
        if ((birdY >= ((r4 + 120) - 35)) && (birdY <= ((r4 + 120) + 35))) {
...
void collision() {
    ...
    if (birdY == ((0 + birdBodyR) - 5) || birdY == (screenHeight - birdBodyR) + 5) {
        lives -= 1;
    }

    //first set
    if ((bird >= barrierX1) && (bird <= (barrierX1 + barrierWidth))) {
        if ((birdY <= r1) || (birdY >= (r1 + roofHeight + birdGap))) {
    ...
    if ((roofX1 <= bird) && (bird <= (roofX1 + roofWidth))) {
        if ((birdY <= (r1 + roofHeight) || (birdY >= (r1 + roofHeight + birdGap)))) {
    ...
    if ((bird >= (barrierX1 + barrierGap)) && (bird <= ((barrierX1 + barrierGap) + barrierWidth))) {
        if ((birdY <= r2) || (birdY >= r2 + roofHeight + birdGap)) {
    ...
    if (((roofX1 + barrierGap) <= bird) && (bird <= ((roofX1 + barrierGap) + roofWidth))) {
        if ((birdY <= (r2 + roofHeight)) || (birdY >= (r2 + roofHeight + birdGap))) {
    ...
    if ((bird >= (barrierX1 + (2 * barrierGap))) && (bird <= ((barrierX1 + (2 * barrierGap) + barrierWidth)))) {
        cout << "tigger: " << birdY << endl;
        if ((birdY <= r3) || (birdY >= r3 + roofHeight + birdGap)) {
            cout << "sushi: " << birdY << endl;
            //reposition bird
            birdY = r3 + 120;
    ...
    if (((roofX1 + (2 * barrierGap)) <= bird) && (bird <= ((roofX1 + (2 * barrierGap)) + roofWidth))) {
        if ((birdY <= (r3 + roofHeight)) || (birdY >= (r3 + roofHeight + birdGap))) {
    ...
    if (powerupFlag == false) {
        if ((bird >= (barrierX2)) && (bird <= ((barrierX2)+barrierWidth))) {
            if ((birdY <= r4) || (birdY >= r4 + roofHeight + birdGap)) {
        ...
        if (((roofX2) <= bird) && (bird <= (roofX2 + roofWidth))) {
            if ((birdY <= (r4 + roofHeight)) || (birdY >= (r4 + roofHeight + birdGap))) {
        ...
        if ((bird >= (barrierX2 + barrierGap)) && (bird <= ((barrierX2 + barrierGap) + barrierWidth))) {
            if ((birdY <= r5) || (birdY >= r5 + roofHeight + birdGap)) {
        ...
        if (((roofX2 + (barrierGap)) <= bird) && (bird <= ((roofX2 + (barrierGap)) + roofWidth))) {
            if ((birdY <= (r5 + roofHeight)) || (birdY >= (r5 + roofHeight + birdGap))) {
        ...
        if ((bird >= (barrierX2 + (2 * barrierGap))) && (bird <= ((barrierX2 + (2 * barrierGap)) + barrierWidth))) {
            if ((birdY <= r6) || (birdY >= r6 + roofHeight + birdGap)) {
        ...
        if (((roofX2 + (2 * barrierGap)) <= bird) && (bird <= ((roofX2 + (2 * barrierGap)) + roofWidth))) {
            if ((birdY <= (r6 + roofHeight)) || (birdY >= (r6 + roofHeight + birdGap))) {
    ...
    if ((bird >= (barrierX3)) && (bird <= ((barrierX3)+barrierWidth))) {
        if ((birdY <= r7) || (birdY >= r7 + roofHeight + birdGap)) {
    ...
    if (((roofX3) <= bird) && (bird <= ((roofX3)+roofWidth))) {
        if ((birdY <= (r7 + roofHeight)) || (birdY >= (r7 + roofHeight + birdGap))) {
    ...
    if ((bird >= (barrierX3 + barrierGap)) && (bird <= ((barrierX3 + barrierGap) + barrierWidth))) {
        if ((birdY <= r8) || (birdY >= r8 + roofHeight + birdGap)) {
    ...
    if (((roofX3 + (barrierGap)) <= bird) && (bird <= ((roofX3 + (barrierGap)) + roofWidth))) {
        if ((birdY <= (r8 + roofHeight)) || (birdY >= (r8 + roofHeight + birdGap))) {
    ...
    if ((bird >= (barrierX3 + (2 * barrierGap))) && (bird <= ((barrierX3 + (2 * barrierGap) + barrierWidth)))) {
        if ((birdY <= r9) || (birdY >= r9 + roofHeight + birdGap)) {
    ...
    if (((roofX3 + (2 * barrierGap)) <= bird) && (bird <= ((roofX3 + (2 * barrierGap)) + roofWidth))) {
        if ((birdY <= (r9 + roofHeight)) || (birdY >= (r9 + roofHeight + birdGap))) {
